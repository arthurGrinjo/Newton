 ...
 */
final class Version20250222203148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_1C52F958D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE car_scheduled_maintenance_job (car_id INT NOT NULL, scheduled_maintenance_job_id INT NOT NULL, INDEX IDX_1C53CBD8C3C6F69F (car_id), INDEX IDX_1C53CBD87B812402 (scheduled_maintenance_job_id), PRIMARY KEY(car_id, scheduled_maintenance_job_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, car_id INT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_81398E09D17F50A6 (uuid), INDEX IDX_81398E09C3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE engineer (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_94176AD9D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE maintenance_job (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_522DB5CED17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE model (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, car_id INT DEFAULT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_D79572D9D17F50A6 (uuid), INDEX IDX_D79572D944F5D008 (brand_id), INDEX IDX_D79572D9C3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE scheduled_maintenance_job (id INT AUTO_INCREMENT NOT NULL, engineer_id INT NOT NULL, maintenance_job_id INT NOT NULL, time_slot_id INT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_DFA05AD5D17F50A6 (uuid), INDEX IDX_DFA05AD5F8D8CDF1 (engineer_id), INDEX IDX_DFA05AD5211D78A0 (maintenance_job_id), INDEX IDX_DFA05AD5D62B0FA (time_slot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE spare_part (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_E3D09D36D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE spare_part_maintenance_job (spare_part_id INT NOT NULL, maintenance_job_id INT NOT NULL, INDEX IDX_CCBFD42549B7A72 (spare_part_id), INDEX IDX_CCBFD425211D78A0 (maintenance_job_id), PRIMARY KEY(spare_part_id, maintenance_job_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE car_scheduled_maintenance_job ADD CONSTRAINT FK_1C53CBD8C3C6F69F FOREIGN KEY (car_id) REFERENCES car (id)');
        $this->addSql('ALTER TABLE car_scheduled_maintenance_job ADD CONSTRAINT FK_1C53CBD87B812402 FOREIGN KEY (scheduled_maintenance_job_id) REFERENCES scheduled_maintenance_job (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE scheduled_maintenance_job_car ADD CONSTRAINT FK_F29C6E067B812402 FOREIGN KEY (scheduled_maintenance_job_id) REFERENCES scheduled_maintenance_job (id)');
        ...
        $this->addSql('ALTER TABLE spare_part_maintenance_job ADD CONSTRAINT FK_CCBFD42549B7A72 FOREIGN KEY (spare_part_id) REFERENCES spare_part (id)');
        $this->addSql('ALTER TABLE spare_part_maintenance_job ADD CONSTRAINT FK_CCBFD425211D78A0 FOREIGN KEY (maintenance_job_id) REFERENCES maintenance_job (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car_scheduled_maintenance_job DROP FOREIGN KEY FK_1C53CBD8C3C6F69F');
        $this->addSql('ALTER TABLE car_scheduled_maintenance_job DROP FOREIGN KEY FK_1C53CBD87B812402');
        ...
        $this->addSql('ALTER TABLE spare_part_maintenance_job DROP FOREIGN KEY FK_CCBFD42549B7A72');
        $this->addSql('ALTER TABLE spare_part_maintenance_job DROP FOREIGN KEY FK_CCBFD425211D78A0');
        ...
        $this->addSql('DROP TABLE car_scheduled_maintenance_job');
        ...
        $this->addSql('DROP TABLE spare_part_maintenance_job');
